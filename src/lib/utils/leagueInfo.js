/*   STEP 1   */
export const leagueID = "1048475586504675328"; // your league ID
export const leagueName = "Dickheads Dynasty"; // your league name
...
export const managers = [
    {
      ...
      "rival": {
        name: "Isaiah", // Can be anything (usually your rival's name)
      ...
      "philosophy": "Trade all our good players for old players",
      "tradingScale": 10, // 1 - 10
      "preferredContact": "Carrier Pigeon", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
      "roster": 2,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "managerID": "723355506621628416",
      "name": "Shmunky",
      "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Shunkville", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 1, // (optional) when did the manager start playing fantasy football
      ...
      "rival": {
        name: "boomerbust", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "managerID": "743697016454057984",
      "name": "boomerbust",
      "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Puka Place", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Shmunky", // Can be anything (usually your rival's name)
